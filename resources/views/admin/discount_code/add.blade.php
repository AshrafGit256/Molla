          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">New Discount Code's Info</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="" method="post">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="Enter Discount Code Name">
                  </div>

                  <div class="form-group">
                    <label>Type<span style="color: red;">*</span></label>
                    <select class="form-control"  name="type" value="{{ old('status') }}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="percent_amount" value="{{ old('percent_amount') }}" class="form-control" placeholder="Percent / Amount">
                  </div>
